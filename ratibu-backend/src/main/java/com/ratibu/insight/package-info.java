/**
 * Derived, read-only business intelligence. Never a source of truth: always regenerated from the other aggregates, never stored as authoritative state. See ADR-007 and ADR-012 section 15.
 *
