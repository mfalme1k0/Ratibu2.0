/**
 * Client aggregate: a business-wide customer identity, never duplicated per shop. See ADR-004 sections 3 to 7 and the duplicate-detection policy in ADR-013 section 7.
 *
