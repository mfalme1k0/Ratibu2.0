/**
 * Payment aggregate: actual money received, independent from Booking, may or may not reference one. Owns overpayment handling (ADR-013 section 3) and payment-method distinctions (cash vs non-cash). See ADR-006 and ADR-011.
 *
