/**
 * Business-level Financial Event: shop-less financial events such as a business-wide owner cash injection, introduced in ADR-013 section 2 to resolve the gap in ADR-006 rule 5.
 *
 ...
 * </ul>
 */
package com.ratibu.financeevent;
